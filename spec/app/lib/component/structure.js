  ...
  describe('generator-openstack:lib/component/structure', function () {
    ...
    describe('configure()', function () {
      ...
      it('should do nothing',
        function () {
          var spies = {
            addFile: spyOn(projectBuilder, 'addFile'),
            writeFile: spyOn(projectBuilder, 'writeFile'),
            removeFile: spyOn(projectBuilder, 'removeFile'),
            ignoreFile: spyOn(projectBuilder, 'ignoreFile'),
            clear: spyOn(projectBuilder, 'clear')
          };
